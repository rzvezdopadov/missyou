    ...
    if (props.regEnable) {
        return (
            <Container className="pt-3 pb-3">
                ...
                {genInputReg("Номер телефона:","regPhone","phone","+71234567890")}
                {genInputReg("Логин:","regLogin","login","vasya666","3-20 символов (уникальное имя на портале, 0..9, a..z)")}
                ...
                <div className="g-3 align-items-center m-2">
                    ...
                    <input type="radio" className="btn-check" name="appointment" id="reg-appointment-onenight"></input>
                        <label className="btn btn-outline-danger m-1" htmlFor="reg-appointment-onenight">На одну ночь</label>
                </div>      
